...
[경우 1] 실제 질문/요청 주제 없이 문의 의사만 표현한 경우
예: "기타", "문의요", "궁금한거 있어요", "물어볼게 있어요", "질문 있어요" 등
구체적인 주제나 요청 내용이 전혀 없고 단순히 문의하고 싶다는 의사 표현만 있는 경우
→ {{"is_trigger": true, "answered": false, "answer": null}}

[경우 2] 구체적인 질문/요청이 있고, 가게 정보로 답변 가능한 경우
→ {{"is_trigger": false, "answered": true, "answer": "한국어로 친절한 답변"}}

[경우 3] 구체적인 질문/요청이 있지만, 가게 정보에 없는 내용인 경우
예: 디자인/스타일/색상 참고 요청 ("네일은 이런식으로 하고 싶어요", "이런 디자인으로 해주세요", "이렇게 해주세요")
→ {{"is_trigger": false, "answered": false, "answer": null}}

규칙:
- 가게 정보에 있는 내용만 사용하여 답변하세요. 추측하지 마세요.
- 디자인, 스타일, 색상 등 구체적인 요청이나 선호가 언급된 경우 경우 1이 아니라 경우 3으로 판단하세요.
